...
type Payload struct {
	...
	XferPipe      []byte `protobuf:"bytes,7,opt,name=xferPipe,proto3" json:"xferPipe,omitempty"`
}
...
func (x *Payload) GetXferPipe() []byte {
	if x != nil {
		return x.XferPipe
	}
	return nil
...
var file_payload_proto_rawDesc = []byte{
	...
	0x02, 0x70, 0x62, 0x22, 0xb9, 0x01, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12,
	...
	0x6f, 0x64, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x78, 0x66, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x78, 0x66, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65, 0x42,
